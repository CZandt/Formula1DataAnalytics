...
session1 = ff1.get_session(2022,'Hungary', 'Q')
session2 = ff1.get_session(2021,'Hungary', 'Q')
...
plt.savefig(f"Telemetry_Comparisons/2021vs2022RedBull.pdf", format="pdf", bbox_inches="tight")